                    ...
                    <ul class="list-unstyled navbar__list">
                        ...
                        <li>
                            <a href="{{ route('admin#userMessage') }}">
                                <i class="fa-solid fa-message"></i>Customer Message</a>
                        </li>
                    </ul>
                </nav>
            </div>
                                        ...
                                        <div class="account-dropdown js-dropdown">
                                            <div class="info clearfix">
                                                <div class="image d-flex align-items-center">
                                                    <a href="#">
                                                        ...
                                                        @else
                                                            <img src="{{ asset('storage/' . Auth::user()->image) }}"
                                                                class="img-tumbnail shadow-sm" alt="">
                                                        @endif
                                                    </a>
                                                </div>
                                                <div class="content">
                                            ...
                                            <div class="account-dropdown__body">
                                                <div class="account-dropdown__item">
                                                    <a href="{{ route('admin#list') }}">
                                                        <i class="fa-solid fa-users-gear"></i> Admin List</a>
                                                </div>
                                            </div>
                                            <div class="account-dropdown__body">
                                                <div class="account-dropdown__item">
                                            ...
                                            <div class="account-dropdown__footer">
                                                <form action="{{ route('logout') }}" method="post"
                                                    ...
                                                    @csrf
                                                    <button class="btn btn-dark col-10" type="submit"><i
